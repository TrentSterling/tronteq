...
impl ShowMode {
    pub const ALL: [ShowMode; 38] = [
        ...
        ShowMode::GlSpiro,
        ShowMode::GlLaser,
        ShowMode::GlDiscoBall,
        ShowMode::GlHexGrid,
        ShowMode::GlLightning,
        ShowMode::GlDna,
        ShowMode::GlBubbles,
        ShowMode::GlCopper,
        ShowMode::GlLedWall,
    ...
    pub fn label(self) -> &'static str {
        match self {
            ...
            ShowMode::GlMatrix => "Matrix rain",
            ShowMode::GlScopeRing => "Scope ring",
            ShowMode::GlSkybox => "Sky",
            ShowMode::GlAurora => "Aurora",
            ShowMode::GlOutrun => "Outrun",
            ShowMode::GlCity => "Spectrum city",
            ShowMode::GlWormhole => "Wormhole",
            ShowMode::GlSpiro => "Spirograph",
            ShowMode::GlLaser => "Laser show",
            ShowMode::GlDiscoBall => "Disco ball",
            ShowMode::GlHexGrid => "Hex pulse",
            ShowMode::GlLightning => "Lightning",
            ShowMode::GlDna => "DNA helix",
            ShowMode::GlBubbles => "Bubbles",
            ShowMode::GlCopper => "Copper bars",
            ShowMode::GlLedWall => "LED wall",
            ShowMode::GlSonar => "Sonar",
            ShowMode::GlPulsar => "Pulsar",
            ShowMode::GlBlackHole => "Black hole",
            ShowMode::GlOcean => "Moonlit ocean",
        }
    }
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            ShowMode::GlMatrix => "gl_matrix",
            ShowMode::GlScopeRing => "gl_scopering",
            ShowMode::GlSkybox => "gl_skybox",
            ShowMode::GlAurora => "gl_aurora",
            ShowMode::GlOutrun => "gl_outrun",
            ShowMode::GlCity => "gl_city",
            ShowMode::GlWormhole => "gl_wormhole",
            ShowMode::GlSpiro => "gl_spiro",
            ShowMode::GlLaser => "gl_laser",
            ShowMode::GlDiscoBall => "gl_discoball",
            ShowMode::GlHexGrid => "gl_hexgrid",
            ShowMode::GlLightning => "gl_lightning",
            ShowMode::GlDna => "gl_dna",
            ShowMode::GlBubbles => "gl_bubbles",
            ShowMode::GlCopper => "gl_copper",
            ShowMode::GlLedWall => "gl_ledwall",
            ShowMode::GlSonar => "gl_sonar",
            ShowMode::GlPulsar => "gl_pulsar",
            ShowMode::GlBlackHole => "gl_blackhole",
            ShowMode::GlOcean => "gl_ocean",
        }
    }
    pub fn from_str(s: &str) -> ShowMode {
        match s {
            ...
            "gl_matrix" => ShowMode::GlMatrix,
            "gl_scopering" => ShowMode::GlScopeRing,
            "gl_skybox" => ShowMode::GlSkybox,
            "gl_aurora" => ShowMode::GlAurora,
            "gl_outrun" => ShowMode::GlOutrun,
            "gl_city" => ShowMode::GlCity,
            "gl_wormhole" => ShowMode::GlWormhole,
            "gl_spiro" => ShowMode::GlSpiro,
            "gl_laser" => ShowMode::GlLaser,
            "gl_discoball" => ShowMode::GlDiscoBall,
            "gl_hexgrid" => ShowMode::GlHexGrid,
            "gl_lightning" => ShowMode::GlLightning,
            "gl_dna" => ShowMode::GlDna,
            "gl_bubbles" => ShowMode::GlBubbles,
            "gl_copper" => ShowMode::GlCopper,
            "gl_ledwall" => ShowMode::GlLedWall,
            "gl_sonar" => ShowMode::GlSonar,
            "gl_pulsar" => ShowMode::GlPulsar,
            "gl_blackhole" => ShowMode::GlBlackHole,
            "gl_ocean" => ShowMode::GlOcean,
            _ => ShowMode::Off,
        }
    }
    ...
    pub fn gl_mode(self) -> Option<crate::glstage::GlMode> {
        ...
        match self {
            ...
            ShowMode::GlMatrix => Some(G::Matrix),
            ShowMode::GlScopeRing => Some(G::ScopeRing),
            ShowMode::GlSkybox => Some(G::Skybox),
            ShowMode::GlAurora => Some(G::Aurora),
            ShowMode::GlOutrun => Some(G::Outrun),
            ShowMode::GlCity => Some(G::City),
            ShowMode::GlWormhole => Some(G::Wormhole),
            ShowMode::GlSpiro => Some(G::Spiro),
            ShowMode::GlLaser => Some(G::Laser),
            ShowMode::GlDiscoBall => Some(G::DiscoBall),
            ShowMode::GlHexGrid => Some(G::HexGrid),
            ShowMode::GlLightning => Some(G::Lightning),
            ShowMode::GlDna => Some(G::Dna),
            ShowMode::GlBubbles => Some(G::Bubbles),
            ShowMode::GlCopper => Some(G::Copper),
            ShowMode::GlLedWall => Some(G::LedWall),
            ShowMode::GlSonar => Some(G::Sonar),
            ShowMode::GlPulsar => Some(G::Pulsar),
            ShowMode::GlBlackHole => Some(G::BlackHole),
            ShowMode::GlOcean => Some(G::Ocean),
            _ => None,
        }
    }
}
